...
void MCAL_UART_GPIO_Set_Pins(USART_Typedef* USARTx)
{
	...
	if(USARTx == USART1)
	{
		...
		// PA11 => CTS
		// PA12 => RTS
		if(Global_UART_Config->HW_Flow_Conterl == UART_HW_Flow_Conterl_RTS || Global_UART_Config->HW_Flow_Conterl == UART_HW_Flow_Conterl_TTS_CTS)
		{
			// PA11 => CTS
		...
		else if(Global_UART_Config->HW_Flow_Conterl == UART_HW_Flow_Conterl_RTS || Global_UART_Config->HW_Flow_Conterl == UART_HW_Flow_Conterl_TTS_CTS)
		{
			// PA12 => RTS
