...
//-----------------------------
typedef struct{
	uint16_t 							UART_Mode ; 		 			 //specifies TX/RX Enable/Disable .
	...
	uint16_t							Payload_length ;   				//specifies the number of data bits transmitted or received in frame.
																		//This parameter must be set based on @Raf_UART_Payload_length_Define .
	uint16_t							Parity ;						//specifies the Parity mode .
																		//@Raf_UART_Parity_Define .
	uint16_t							Stop_Bits ;						//specifies the number of stop bits transmitted .
																		//@Raf_UART_Stop_Bits_Define .
	uint16_t							HW_Flow_Conterl ;				//specifies whether the Hardware flow control mode is enable or disable .
...
#define UART_Mode_TX_RX				    (uint32_t)(1<<3 | 1<<2)  		// Bit 2 RE: Receiver enable & Bit 3 TE: Transmitter enable .
...
#define UART_HW_Flow_Conterl_RTS_CTS	((uint32_t)(1<<8 | 1<<9))
